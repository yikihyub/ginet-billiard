    ...
    <nav className="bg-white text-black">
      <div className="container mx-auto flex max-w-screen-lg items-center justify-between px-4 py-3">
        ...
        <ul className="flex space-x-4">
          ...
          <li>
            <Link href="/desktop/record" className="hover:underline">
              <Search />
            </Link>
          </li>
          <li>
            <Link href="/desktop/reservation" className="hover:underline">
              <CalendarDays />
            </Link>
          </li>
          <li>
            <Link href="/desktop/mypage" className="hover:underline">
              <User />
            </Link>
          </li>
          {/* <li>
