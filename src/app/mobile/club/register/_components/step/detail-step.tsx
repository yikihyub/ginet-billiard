      ...
      <div className="space-y-6">
        <div>
          ...
          <textarea
            ...
            className="h-32 w-full rounded-lg border border-gray-300 p-3 focus:border-green-500 focus:outline-none"
            required
          />
        </div>
        ...
        <div>
          ...
          {/* 태그 입력 필드 */}
          <div className="mb-28 mt-2 flex flex-col">
